...
area = np.random.uniform(3000, 500000, size=n)
distance_capital = np.random.uniform(0.5, 140, size=n)
...
crop_yield = np.random.randint(56, 73, size=n)
...
beta_yield = 0.32
gamma_access = 0.13
gamma_ownership = 0.14
gamma_shape = 0.12
gamma_marked = 0.13
gamma_south = 0.22  # Southern forest-steppe more expensive
...
# Save to CSV
df_level3.to_csv('data/data_level_3.csv', index=False)
print("Data saved to 'data/data_level_3.csv'")
