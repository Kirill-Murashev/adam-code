...
fig.tight_layout()
fig.savefig("output_charts/level_3_price_distribution.png")
plt.close(fig)
...
fig.savefig("output_charts/level_3_violin_binary.png")
plt.close(fig)
