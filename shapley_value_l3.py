...
os.makedirs('level_3_visualizations', exist_ok=True)
...
importance_df.to_csv('primary_models/shap_importance_l3.csv', index=False)
...
plt.tight_layout()
plt.savefig('level_3_visualizations/shap_importance.png')
plt.close()

# 9) Create and save summary beeswarm plot
shap.summary_plot(shap_values, X_scaled_df, plot_type="dot", show=False)
plt.title('SHAP Summary Plot')
plt.savefig('level_3_visualizations/shap_summary.png', bbox_inches='tight')
plt.close()
